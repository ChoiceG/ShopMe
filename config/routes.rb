...
Rails.application.routes.draw do
  ...
  # Devise routes for admins (skip registrations if not needed)
  devise_for :admins, skip: [ :registrations ], controllers: {
    sessions: "admins/sessions",
    passwords: "admins/passwords"
  }

  # Admin namespace and dashboard
  namespace :admin do
    root to: "admin#index", as: :admin_root  # Points to AdminController#index
  ...
  # Public root path for regular users
  root to: "home#index"
